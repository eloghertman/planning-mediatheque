...
*Version : v35 — 22 août 2026 (grille "horaires d'équipes" harmonisée + lecture directe par le moteur, cf. §24)*
...
- `compare_planning.py` — compare un planning calculé au fichier de
  référence Excel (voir §10). Pas touché le 18/08.
...
- Intégrer les 3 briques (`regeneration_lecture.py`, `regeneration_calcul.py`,
  ...
  un planning existant") : upload du fichier, sélection semaine + jour(s),
  bouton de lancement, affichage résumé + téléchargement.
